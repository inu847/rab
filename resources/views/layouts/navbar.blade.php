    ...
    <div class="navbar-header">
        ...
        <div class="top-left-part">
            <a class="logo" href="index.html">
                <b>
                    <img src="{{asset('storage/'.generalSetting()->site_logo)}}" alt="home" style="width: 50px; border-radius: 50%;" />
                </b>
                <span style="font-family: sans-serif;">
                    {{generalSetting()->site_title2}}
                </span>
            </a>
        </div>
        ...
        <ul class="nav navbar-top-links navbar-right pull-right">
            ...
            <li>
                <a class="waves-effect waves-light b-r-0 font-20" href="javascript:void(0)" style="padding-right: 0px">
                    <i class="icon-user"></i> {{ Auth::guard('user')->user()->username }}
                </a>
            </li>
